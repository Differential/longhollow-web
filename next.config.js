module.exports = {
  ...
  async redirects() {
    return [
      ...
      { source: '/explore-our-2024-annual-report', destination: 'https://impact.longhollow.com', permanent: true },
      { source: '/softball', destination: '/mens-church-softball-league', permanent: true },
      { source: '/shroud', destination: '/the-who-is-the-man-of-the-shroud-experience-at-long-hollow', permanent: true },
      { source: '/hendersonvillestorytime', destination: '/hendersonville-sleigh-bell-story-time-a-christmas-party-for-preschoolers', permanent: true },
      ...
      { source: '/anxiety-support-group', destination: 'https://my.longhollow.com/page/2823?GroupId=1161588&PageType=care', permanent: true },
      ...
      { source: '/hendersonvillemangerbuild', destination: '/hendersonville-manger-build-2025', permanent: true },
      { source: '/hendersonvilledeckthehollow', destination: '/hendersonville-deck-the-hollow-decorate-long-hollow-for-the-christmas-season', permanent: true },
      ...
      { source: '/equip', destination: 'https://longhollow.com/wednesdays-at-lh-fall-2026', permanent: true },
      ...
      { source: '/gallatindatenight', destination: '/gallatin-date-night-a-songwriters-round', permanent: true },
      ...
      { source: '/missionssunday', destination: '/missions-sunday-2025-force-for-good-near-and-far', permanent: true },
      { source: '/missionsunday', destination: '/missions-sunday-2025-force-for-good-near-and-far', permanent: true },
      ...
      { source: '/launch', destination: '/launch-night-fall-2025', permanent: true },
      ...
      { source: '/5thgrademissions', destination: '/5th-grade-spring-break-family-mission-trip', permanent: true },
      ...
      { source: '/wednesdays', destination: '/wednesdays-at-lh-spring', permanent: true },
      { source: '/firstrespondermeals', destination: 'https://longhollow.com/first-responder-meals-help-us-care-for-our-first-responders-on-christmas-day', permanent: true },
      ...
      { source: '/wednesday', destination: '/wednesdays-at-lh-spring', permanent: true },
      { source: '/wednesdaysatlh', destination: '/wednesdays-at-lh-spring', permanent: true },
      ...
      { source: '/kidscon', destination: '/kids-con-is-coming-this-june', permanent: true },
      ...
      { source: '/camp', destination: '/long-hollow-weekly-main', permanent: true },
      ...
      { source: '/studentmissions', destination: 'https://longhollow.com/student-spring-break-mission-trips-2026-middle-school-and-high-school', permanent: true },
      ...
      { source: '/survey', destination: 'https://www.surveymonkey.com/r/VBXHWZ6', permanent: true },
      ...
      { source: '/pray', destination: 'https://longhollow.com/connect/prayer-team-and-prayer-requests', permanent: true },
      ...
      { source: '/offering', destination: '/spring-offering-2026', permanent: true },
      ...
      { source: '/notes', destination: 'http://bible.com/events/49625124', permanent: true },
      ...
      { source: '/connectsunday', destination: 'https://longhollow.com/connect-sunday', permanent: true },
    ];
  }
};
