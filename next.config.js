module.exports = {
  ...
  async redirects() {
    return [
      ...
      { source: '/notes', destination: 'http://bible.com/events/49584096', permanent: true },
      { source: '/missions-partner-connect', destination: 'https://longhollow.com/missions-partner-connect', permanent: true }
    ];      
  }
};
